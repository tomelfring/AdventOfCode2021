...
class Main
{
    ...
    {
        val reflection = Reflections("eu.elfring.adventofcode2021.days")
        val toRegister2021 = reflection.getSubTypesOf(AoCPuzzle::class.java)
            .map { it.constructors.first().newInstance() as AoCPuzzle }.toList()

        toRegister2021.forEach { puzzles[it.day] = it }
    }
}
